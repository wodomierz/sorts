...
//    print_Devtab(in, size, size, 0,"BEF RESULT", indexedPrint);
//    print_Devtab(out, size, size, 0,"BEF RESULT OUT", indexedPrint);
//    checkMem();
//    checkMem();
//    checkMem();
//    checkMem();
...
//    PRINT1("lq after\n");
//    print_Devtab(out, size, size, 0,"RESULT", indexedPrint);
